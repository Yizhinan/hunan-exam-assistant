...
3. **内容论据** (权重 25%)：论据是否充实具体，能否结合湖南实际，引用政策文件是否恰当
...
class GradingEngine:
    ...
    def grade(self, question: str, answer: str, use_rag: bool = True) -> GradingResult:
        """
        ...
        user_prompt = self._build_prompt(question, answer, rag_context)
